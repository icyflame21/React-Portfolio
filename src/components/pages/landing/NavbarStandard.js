            ...
            <Nav className="ms-auto">
              <Flex direction='row' alignItems='center' >
                ...
                <Button as='a' href="#skills"
                  variant="outline-primary" className='ms-2 fs-0 fw-medium border-0 rounded-pill'>Skills</Button>{' '}
                <Button as='a' href="#background"
                  variant="outline-primary" className='ms-2 fs-0 fw-medium border-0 rounded-pill'>Background</Button>{' '}
                <Button as='a' href="#services"
                  variant="outline-primary" className='ms-2 fs-0 fw-medium border-0 rounded-pill'>Services</Button>{' '}
                <Button as='a' href="#projects"
                  variant="outline-primary" className='ms-2 fs-0 fw-medium border-0 rounded-pill'>Projects</Button>{' '}
                <Button as='a' href="#contact"
                  variant="outline-primary" className='ms-2 fs-0 fw-medium border-0 rounded-pill'>Contact</Button>
                <Nav.Link
                  className="ms-2 theme-control-toggle"
