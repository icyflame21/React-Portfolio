...
export const projectData = [
  ...
  },
  {
    ...
    subTitle: "Served as the Core Lead Developer, optimizing the user experience through effective Redux state management and streamlining app development for both iOS and Android platforms. Core responsibilities included overseeing inventory and order management, implementing efficient raw material sourcing strategies, and ensuring agile development based on client feedback.",
