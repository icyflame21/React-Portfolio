...
export const VerticalTimelineData = [
  {
    ...
    year: '2022-Present',
    date: '18 Jul',
    icon: <GiSuitcase className='fs-2 text-linkedin' />
  },
  {
  ...
  //   year: '2022',
  //   date: 'May 5-Jul 15',
  //   icon: <GiSuitcase className='fs-2 text-success' />
  // },
  {
    title: 'Masai',
    description:
    ...
    year: '2021-2022',
    date: '20 Sep-13 Jun',
    icon: <MdOutlineModelTraining className='fs-2 text-warning' />
  },
  {
    ...
    year: '2018-2022',
    date: '18 Aug-25 Aug',
    icon: <MdOutlineCastForEducation className='fs-2 text-danger' />
  }
];
